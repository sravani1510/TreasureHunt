...
SECRET_KEY = 'django-insecure-ls6wb-%yys6=athe(bn+vrd%osy&j97x$6f(n@a18@hyfd!oz!'
...
#how we are going to access that images in browser
#/media/profile_pics/pic name
MEDIA_URL = '/media/'


CRISPY_TEMPLATE_PACK = 'bootstrap4'

LOGIN_REDIRECT_URL = 'level1'
